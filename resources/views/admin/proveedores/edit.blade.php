            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="tipoDocumento" name="tipoDocumento">
                        <option value="CC" {{ $proveedore->tipoDocumento == "CC" ? 'selected' : '' }}>C.C</option>
                        <option value="CE" {{ $proveedore->tipoDocumento == "CE" ? 'selected' : '' }}>C.E</option>
                        <option value="TI" {{ $proveedore->tipoDocumento == "TI" ? 'selected' : '' }}>T.I</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="estado" id="estado">
                        <option value="1" {{ $proveedore->estado == "1" ? 'selected' : '' }}>Activo</option>
                        <option value="0" {{ $proveedore->estado == "0" ? 'selected' : '' }}>Inactivo</option>
                    </select>
                    ...
                    {!! Form::submit('Actualizar Proveedor', ['class' => 'btn btn-primary btn-sm']) !!}
